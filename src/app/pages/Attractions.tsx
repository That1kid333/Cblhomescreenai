...
const EVENTS: EventItem[] = [
  ...
  {
    id: 14,
    name: 'Mr. Smalls Theatre — Live Tonight',
    venue: 'Mr. Smalls Theatre · Millvale',
    cat: 'MUSIC',
    tag: 'Indie · Touring Act',
    month: 'MAY',
    day: 29,
    when: 'Fri 8:00 PM',
    price: 'From $25',
  ...
  {
    id: 15,
    name: "Gooski's Live Punk Night",
    venue: "Gooski's · Polish Hill",
    cat: 'NIGHT',
    tag: 'Dive Bar',
    month: 'MAY',
    day: 30,
  ...
  },
  {
    ...
    venue: 'National Aviary · North Side',
    cat: 'FAMILY',
    tag: 'All Ages',
    month: 'MAY',
    day: 24,
    when: 'Daily 10 AM – 5 PM',
    price: '$18 adult · $15 kids',
    src: 'Visit Pittsburgh',
    img: 'https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=800&h=540&fit=crop',
  ...
  },
  {
    ...
    venue: "Children's Museum · North Side",
    cat: 'FAMILY',
    tag: 'Hands-On',
    month: 'MAY',
    day: 25,
    when: 'Daily 10 AM – 5 PM',
    price: '$18 · under 2 free',
    src: 'Visit Pittsburgh',
    img: 'https://images.unsplash.com/photo-1531913764164-f85c52e6e654?w=800&h=540&fit=crop',
