...
.cbl-blog .hero-inner { display:grid; grid-template-columns:1fr; gap:0; align-items:start; max-width:1280px; margin:0 auto; position:relative; z-index:2; }
.cbl-blog .hero-streams { position:absolute; inset:0; z-index:1; pointer-events:none; }
.cbl-blog .eyebrow {
...
/* Desktop/tablet: float the icon so it doesn't inflate the title row — the
   ...
   Below 721px the mobile rule positions the icon instead. */
@media (min-width:721px){
  .cbl-blog h1.hero-title .blog-icon {
...
@media (max-width:720px) {
  .cbl-blog h1.hero-title { display:flex; flex-wrap:nowrap; position:relative; gap:0; align-items:flex-start; font-size:clamp(34px,11vw,44px); }
