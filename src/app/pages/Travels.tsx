...
@media (max-width:720px){
  .cbl-travels h1.hero-title { flex-wrap:wrap; gap:10px 14px; font-size:clamp(30px,8vw,44px); }
  .cbl-travels h1.hero-title .stays-icon { display:flex; width:60px; height:60px; }
