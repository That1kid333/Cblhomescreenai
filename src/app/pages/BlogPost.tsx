...
.cbl-post .body figure.mdfig.logo { max-width:none; margin:20px 0 6px; }
.cbl-post .body figure.mdfig.logo img { width:auto; height:42px; max-width:100%; border:0; border-radius:12px 0 12px 0; box-shadow:0 4px 16px rgba(0,0,0,.4); }
